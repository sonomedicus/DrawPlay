...
public class Cat {
	...
	//changed the EYE_Y to 6
	private static final int EYE_Y = HEAD_DIMENSION/6;
	private static final int EYE_X = HEAD_DIMENSION/4;
	private static final int EYE_SEPARATION = HEAD_DIMENSION/3;
	// pick eye dimensions
	//Changed Eye Height, width, and mouth height
	private static final int EYE_HEIGHT = 200;
	private static final int EYE_WIDTH = 100;
	// pick mouth height, width is based on head dimension
	private static final int MOUTH_HEIGHT = 1000;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		int y=catY;
		// Draw the head
		// The cat now has a magenta head, black eyes, and a blue mouth
